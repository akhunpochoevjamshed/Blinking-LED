...
FINAL_IMAGE=${DISTDIR}/Blinking_LED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Blinking_LED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
